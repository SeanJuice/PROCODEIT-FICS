...
const   rootURL = 'https://localhost:44389/api/Trainee/'
...
export class TraineeService {
  ...
  UpdateTrainee(formData){
    ...
    return this.http.post('https://localhost:44389/api/Trainee/MaintainTrainee/', formData,httpOptions).pipe(share());
  }
