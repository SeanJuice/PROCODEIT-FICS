...
const TraineerootURL = '  https://apifics.azurewebsites.net/api/Trainee/';
...
export class TraineesService {
  ...
  MaintainTrainee(user:any): Observable<any>{
    ...
    return this.http.post(`  https://apifics.azurewebsites.net/api/Trainee/MantainTrainee/${this.auth.loginId}`,user, httpOptions);
  }
